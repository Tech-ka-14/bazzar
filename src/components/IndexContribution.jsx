...
const IndexContribution = () => {
  ...
  const fetchContributionData = async () => {
    ...
    // The desktop shell ships no backend, so this fails gracefully with an empty table.
    try {
  ...
  return (
    <div className="bg-black text-white p-6 font-sans rounded-lg">
              ...
              {contributions.length === 0 && (
                <tr>
                  <td colSpan="5" className="p-6 text-center text-gray-500">
                    No contribution data available. Connect a data backend to populate this table.
                  </td>
                </tr>
              )}
            </tbody>
