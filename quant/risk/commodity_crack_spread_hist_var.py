...
def calculate_commodity_historical_var(
    ho_contracts: np.ndarray,
    ho_spread_changes: np.ndarray,
    ul_contracts: np.ndarray,
    ul_spread_changes: np.ndarray,
...
va_ho, va_ul, va_total = calculate_commodity_historical_var(
    mock_ho_contracts, mock_ho_changes, mock_ul_contracts, mock_ul_changes
)
