...
print(
    f"If calculating 10-day Mixture VaR with +0.25 autocorrelation, scale daily volatilities by sqrt({h_tilde_pos:.2f}) (approx {np.sqrt(h_tilde_pos):.2f}) instead of sqrt({h_days})."
)
