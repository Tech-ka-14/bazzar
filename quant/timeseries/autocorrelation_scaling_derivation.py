...
def calculate_autocorrelated_var(
    mu_1: float, sigma_1: float, h: int, rho: float, alpha: float
) -> float:
    """
...
var_250, h_tilde_250 = calculate_autocorrelated_var(
    mu_daily, sigma_daily, 250, rho_ar1, significance
)
