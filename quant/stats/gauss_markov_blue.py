...
def prove_gauss_markov_theorem(
    ...
    print("--- GAUSS-MARKOV THEOREM SIMULATION ---")
...
# Run the proof
prove_gauss_markov_theorem(
    true_alpha=5.0, true_beta=2.0, error_volatility=3.0, sample_size=50, num_simulations=5000
)
